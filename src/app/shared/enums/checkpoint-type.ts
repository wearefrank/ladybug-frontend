...
export const CHECKPOINT_TYPE_STRINGS: { [key in CheckpointType]: string } = {
  ...
  [CheckpointType.Abortpoint]:
    'bi bi-x-lg red icon-size scale-down bolder-icon',
  [CheckpointType.Inputpoint]:
    'bi bi-arrow-right icon-size scale-down bolder-icon',
  [CheckpointType.Outputpoint]:
    'bi bi-arrow-left icon-size scale-down bolder-icon',
  [CheckpointType.Infopoint]:
    'bi bi-info-square icon-size scale-down bold-icon',
  [CheckpointType.ThreadStartpointError]:
    'bi bi-fast-forward icon-size bold-icon',
  [CheckpointType.ThreadStartpoint]:
    'bi bi-chevron-double-right icon-size scale-down bold-icon',
  [CheckpointType.ThreadEndpoint]:
    'bi bi-chevron-double-left icon-size scale-down bold-icon',
};
